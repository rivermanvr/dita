...
const users = [
  { id: 4, name: 'vince', email: 'vince@rivcon.com', username: 'vince', password: 'dita', profilePic:'https://usatftw.files.wordpress.com/2017/11/usp_nba__philadelphia_76ers_at_los_angeles_lakers_95365191-e1511314321431.jpg?w=1000&h=600&crop=1'},
  { id: 2, name: 'kaz', email: 'kaz@dita.net', username: 'kaz', password: 'dita', profilePic:'https://imagesvc.timeincapp.com/v3/fan/image?url=https://thesixersense.com/wp-content/uploads/getty-images/2017/08/830248940-2017-nba-rookie-photo-shoot.jpg.jpg&' },
  { id: 3, name: 'wasif', email: 'wasif@dita.net', username: 'wasif', password: 'dita', profilePic:'http://a1.espncdn.com/combiner/i?img=%2Fphoto%2F2017%2F0303%2Fr186814_1296x729_16%2D9.jpg' },
  { id: 1, name: 'murray', email: 'murray@dita.net', 'username': 'murray', password: 'dita', profilePic:'https://img.bleacherreport.net/img/images/photos/003/706/425/d41845ec2e5fbd547a2be9b4be9d8e34_crop_north.jpg?h=533&w=800&q=70&crop_x=center&crop_y=top'}
]
...
const posts = [
  ...
  { id: 8, title: 'Invited to take a test!', body: 'IBM sent a link for a test, I have 5 days to complete it', zip: '07424', latitude: 40.881172, longitude: -74.212063, userId: 4, storylineId: 2 },
  ...
  { id: 19, title: 'Thoughts Monday 11-20', body: 'Need to spend a 1/2 hour on -crack-the-code-interview each day', zip: '07424', latitude: 40.881172, longitude: -74.212063, userId: 3 },
  { id: 20, title: 'ToDo Tuesday 11-21', body: 'Develop a 1 page resume, keep 3 pager', zip: '07424', latitude: 40.881172, longitude: -74.212063, userId: 3 },
  { id: 21, title: 'ToDo Friday 11-17', body: 'Going to brunch at the Culinary Institute on Sat', zip: '10026', latitude: 41.745849, longitude: -73.932718, userId: 3 },
  { id: 22, title: 'RivCon ToDo', body: 'Need to do paperwork for Corp Insurance Coverages', zip: '07424', latitude: 40.881172, longitude: -74.212063, userId: 3 },
  { id: 23, title: 'Garth Brooks', body: 'tickets to Garth concert on friday 12-1 at NJPAC', zip: '07102', latitude: 40.735657, longitude: -74.172367, userId: 3 },
  { id: 24, title: 'Fullstack finished', body: 'December 7, 2017 is our last day of class! - graduating', zip: '10005', latitude: 40.704595, longitude: -74.008906, userId: 3 },
  { id: 25, title: 'ToDo Tuesday 11-21', body: 'Develop a 1 page resume, keep 3 pager', zip: '07424', latitude: 40.881172, longitude: -74.212063, userId: 3 },
  { id: 26, title: 'Invited to take a test!', body: 'IBM sent a link for a test, I have 5 days to complete it', zip: '07424', latitude: 40.881172, longitude: -74.212063, userId: 3, storylineId: 5 },
  { id: 27, title: 'Test Response', body: 'my first test - need to practice for this kind of test', zip: '07424', latitude: 40.881172, longitude: -74.212063, userId: 4, storylineId: 6 },
  { id: 28, title: 'Rejection', body: 'not surprised - was rejected, but now I know what to expect on these tests', zip: '07424', latitude: 40.881172, longitude: -74.212063, userId: 3, storylineId: 5 },
  { id: 29, title: 'reusable components', body: 'This project has me focused on creating single function - reusable components', zip: '10005', latitude: 40.704595, longitude: -74.008906, userId: 3, storylineId: 6 },
  { id: 30, title: 'Working on my final items', body: 'need to get these final items finished before Tuesday night', zip: '10005', latitude: 40.704595, longitude: -74.008906, userId: 3, storylineId: 6 },
  { id: 31, title: '1 or two nights to finish up', body: 'We need to clean up our code quickly, only a few days left', zip: '10005', latitude: 40.704595, longitude: -74.008906, userId: 3, storylineId: 6 },
  { id: 32, title: 'presenting results', body: 'We have to present our final results on Tuesday the 5th of Dec.', zip: '10005', latitude: 40.704595, longitude: -74.008906, userId: 3, storylineId: 6 },
  { id: 33, title: 'Working on the ceiling', body: 'Neal had a leak in the roof, showing him how to spackle the ceiling', zip: '07076', latitude: 40.640040, longitude: -74.369018, userId: 3, storylineId: 4 },
  { id: 34, title: 'molding', body: 'working on the basement floor molding now', zip: '07076', latitude: 40.640040, longitude: -74.369018, userId: 3, storylineId: 4 },
  { id: 35, title: 'doing puzzles', body: 'doing puzzles with the grand-kids.  Ryan is REALLY GOOD at it.', zip: '07076', latitude: 40.640040, longitude: -74.369018, userId: 3, storylineId: 4 },
  { id: 36, title: 'pizza time', body: 'time for pizza and garlic bread for dinner, it was a nice day', zip: '07076', latitude: 40.640040, longitude: -74.369018, userId: 3, storylineId: 4 }
]
...
const stories = [
  ...
  { id: 4, title: 'Sunday with the family', description: 'At Pam & Neal"s home', userId: 3 },
  { id: 5, title: 'Interview at IBM', description: 'sent my resume for fun & got an interview', userId: 3 },
  { id: 6, title: 'Working on the final project', description: 'Fullstack Academy final project', userId: 3 }
]
