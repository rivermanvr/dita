...
//Originally was going to make the geoLoc search bar with a map.  This map will run with no errors
//did not use this component, but want to keep it as a reference. - Vince Rios
